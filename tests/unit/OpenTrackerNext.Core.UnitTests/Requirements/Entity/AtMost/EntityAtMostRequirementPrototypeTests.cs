...
public sealed class EntityAtMostRequirementPrototypeTests
{
    private readonly EntityAtMostRequirementPrototype _subject = new();
    ...
    public void Entity_ShouldSerializeAsExpected()
    {
        ...
        jsonObject[nameof(EntityAtMostRequirementPrototype.Entity)]?
            .Value<string>()
            .Should()
    ...
    public void Entity_ShouldDeserializeAsExpected()
    {
        ...
        {
            { nameof(EntityAtMostRequirementPrototype.Entity), new JValue(entity.Value.ToString()) }
        };

        var json = jsonObject.ToString(Formatting.Indented);

        var subject = JsonContext.Deserialize<EntityAtMostRequirementPrototype>(json);
    ...
    public void RequiredValue_ShouldSerializeAsExpected()
    {
        ...
        jsonObject[nameof(EntityAtMostRequirementPrototype.RequiredValue)]?
            .Value<int>()
            .Should()
            .Be(requiredValue);
    }
    ...
    public void RequiredValue_ShouldDeserializeAsExpected()
    {
        ...
        var jsonObject = new JObject
        {
            { nameof(EntityAtMostRequirementPrototype.RequiredValue), new JValue(requiredValue) }
        };
    ...
    public void MakeValueEqualTo_ShouldSetPropertiesValueEqualToOther()
    {
        ...
        var other = new EntityAtMostRequirementPrototype
        {
            Entity = entity,
    ...
    public void Clone_ShouldReturnNewEquivalentInstance()
    {
        ...
        clone.Should()
            .BeOfType<EntityAtMostRequirementPrototype>()
