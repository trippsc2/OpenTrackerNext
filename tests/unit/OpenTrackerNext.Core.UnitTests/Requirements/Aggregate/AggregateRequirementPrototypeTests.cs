...
public sealed class AggregateRequirementPrototypeTests
{
    private readonly AggregateRequirementPrototype _subject = new();
    ...
    public void DocumentChanges_ShouldEmitWhenPropertiesChange()
    {
        ...
        requirement.Content = new AggregateRequirementPrototype();
    ...
    {
        _subject.WhenAnyObservable(x => x.DocumentChanges);
    ...
    public void Requirements_ShouldSerializeAsExpected()
    {
        ...
        jsonObject[nameof(AggregateRequirementPrototype.Requirements)]?
            .Values<JObject>()
            .Should()
            .HaveCount(2);
    }
    ...
    public void Requirements_ShouldDeserializeAsExpected()
    {
        ...
        {
            {
                nameof(AggregateRequirementPrototype.Requirements),
                new JArray
                {
                    new JObject(),
                    new JObject()
        ...
        var requirement = JsonContext.Deserialize<AggregateRequirementPrototype>(json);
    ...
    public void MakeValueEqualTo_ShouldSetValuesEqual_WhenRequirementsCountIsSameAndSameType()
    {
        ...
        var other = new AggregateRequirementPrototype
        {
            Requirements =
            [
                otherRequirement1,
