...
public sealed class DialogViewModelTests : IDisposable
{
    ...
    private readonly YesNoDialogViewModel _subject = new(null)
    {
        Title = Title,
        Message = Message
    };

    public DialogViewModelTests()
    {
        _subject.Activator
            .Activate()
    ...
    {
        var subject = new YesNoDialogViewModel(null)
        {
            MaxWidth = maxWidth,
            Title = Title,
            Message = Message
    ...
    public void IconIsVisible_ShouldReturnExpected(bool expected, string? iconName)
    {
        ...
        var subject = new YesNoDialogViewModel(icon)
        {
            Title = Title,
            Message = Message
        };
