...
/// <summary>
/// Represents a requirement that the specified entity must have at least the specified value.
/// </summary>
public sealed class EntityAtLeastRequirement : ReactiveObject, IRequirement
{
    private readonly CompositeDisposable _disposables = new();
    private readonly IEntity _entity;

    /// <summary>
    /// Initializes a new instance of the <see cref="EntityAtLeastRequirement"/> class.
    /// </summary>
    /// <param name="entity">
    ...
    /// </param>
    public EntityAtLeastRequirement(IEntity entity, int requiredValue)
    {
        _entity = entity;
